...
Sub-task:       S0 COMPLETE — all 13 foundation sub-tasks delivered; S1 assumptions walkthrough is next
Pause rating:   🟡 AMBER
Live billable:  none
...
Next action:    Walk through the S1 ASSUMPTIONS block, then begin S1 sub-task 1 only after confirmation
...
|---|---|---|---|---|---|
| ✓ | S0 Foundation | — | $1 | complete | pending posting |
